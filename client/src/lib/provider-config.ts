...
const awsConfig: ProviderConfig = {
  ...
  colors: {
    ...
    chartPrimary: '#FF9900',
    chartPalette: ['#FF9900', '#232F3E', '#569A31', '#3B48CC', '#8C4FFF', '#DD344C', '#01A88D', '#FF6600', '#146EB4', '#E07941', '#7B68EE', '#2EA597', '#C7511F', '#6B4C9A', '#3C8C2F', '#D4477E', '#4B7BBE', '#8B6914'],
  },
  ...
  orgUnits: [
    { id: 'acct-001', name: 'Production Workloads', description: 'Primary production environment', environment: 'Prod', primaryRegion: 'us-east-1', contactName: 'Sarah Chen', contactEmail: 'sarah.chen@qucoon.com', budget: 350000, efficiencyScore: 82, status: 'active' },
    { id: 'acct-002', name: 'Development & Testing', description: 'Dev/Test environments', environment: 'Dev/Test', primaryRegion: 'us-west-2', contactName: 'James Wilson', contactEmail: 'james.wilson@qucoon.com', budget: 120000, efficiencyScore: 71, status: 'active' },
    { id: 'acct-003', name: 'Data Analytics', description: 'Analytics and data pipelines', environment: 'Analytics', primaryRegion: 'us-east-1', contactName: 'Priya Patel', contactEmail: 'priya.patel@qucoon.com', budget: 280000, efficiencyScore: 88, status: 'active' },
    { id: 'acct-004', name: 'Machine Learning', description: 'ML training and inference', environment: 'ML/AI', primaryRegion: 'us-west-2', contactName: 'David Kim', contactEmail: 'david.kim@qucoon.com', budget: 400000, efficiencyScore: 76, status: 'active' },
    { id: 'acct-005', name: 'Security & Compliance', description: 'Security tools and logging', environment: 'Security', primaryRegion: 'us-east-1', contactName: 'Maria Garcia', contactEmail: 'maria.garcia@qucoon.com', budget: 95000, efficiencyScore: 91, status: 'active' },
    { id: 'acct-006', name: 'Shared Services', description: 'Shared platform infrastructure', environment: 'Platform', primaryRegion: 'eu-west-1', contactName: 'Tom Brown', contactEmail: 'tom.brown@qucoon.com', budget: 200000, efficiencyScore: 84, status: 'active' },
    { id: 'acct-007', name: 'Mobile Backend', description: 'Mobile app backend services', environment: 'App', primaryRegion: 'ap-southeast-1', contactName: 'Lisa Wang', contactEmail: 'lisa.wang@qucoon.com', budget: 150000, efficiencyScore: 79, status: 'active' },
    { id: 'acct-008', name: 'Disaster Recovery', description: 'DR and backup systems', environment: 'DR', primaryRegion: 'eu-central-1', contactName: 'Robert Taylor', contactEmail: 'robert.taylor@qucoon.com', budget: 80000, efficiencyScore: 87, status: 'active' },
  ],
  recommendationTypes: [
...
const azureConfig: ProviderConfig = {
  ...
  colors: {
    ...
    chartPrimary: '#0078D4',
    chartPalette: ['#0078D4', '#50E6FF', '#E8731A', '#3999C6', '#326DE6', '#F2C811', '#A4262C', '#10A37F', '#8661C5', '#5BA691', '#C23B22', '#2B7A78', '#F57F17', '#6A1B9A', '#00838F', '#D4577B', '#4CAF50', '#795548'],
  },
  ...
  orgUnits: [
    { id: 'sub-001', name: 'Production - Europe', description: 'European production workloads', environment: 'Prod', primaryRegion: 'westeurope', contactName: 'Emma Schmidt', contactEmail: 'emma.schmidt@qucoon.com', budget: 300000, efficiencyScore: 80, status: 'active' },
    { id: 'sub-002', name: 'Production - US', description: 'US production workloads', environment: 'Prod', primaryRegion: 'eastus', contactName: 'Michael Johnson', contactEmail: 'michael.johnson@qucoon.com', budget: 380000, efficiencyScore: 83, status: 'active' },
    { id: 'sub-003', name: 'Development', description: 'Development environment', environment: 'Dev', primaryRegion: 'westeurope', contactName: 'Sophie Martin', contactEmail: 'sophie.martin@qucoon.com', budget: 100000, efficiencyScore: 69, status: 'active' },
    { id: 'sub-004', name: 'Testing & QA', description: 'QA and testing environment', environment: 'QA', primaryRegion: 'uksouth', contactName: 'Daniel Lee', contactEmail: 'daniel.lee@qucoon.com', budget: 85000, efficiencyScore: 74, status: 'active' },
    { id: 'sub-005', name: 'Data Platform', description: 'Analytics and data platform', environment: 'Analytics', primaryRegion: 'northeurope', contactName: 'Anna Kowalski', contactEmail: 'anna.kowalski@qucoon.com', budget: 250000, efficiencyScore: 86, status: 'active' },
    { id: 'sub-006', name: 'AI & Machine Learning', description: 'ML training and AI services', environment: 'AI/ML', primaryRegion: 'eastus2', contactName: 'Chris Park', contactEmail: 'chris.park@qucoon.com', budget: 320000, efficiencyScore: 77, status: 'active' },
    { id: 'sub-007', name: 'Shared Infrastructure', description: 'Shared platform services', environment: 'Platform', primaryRegion: 'westeurope', contactName: 'Laura Rossi', contactEmail: 'laura.rossi@qucoon.com', budget: 180000, efficiencyScore: 85, status: 'active' },
    { id: 'sub-008', name: 'Disaster Recovery', description: 'DR and business continuity', environment: 'DR', primaryRegion: 'southeastasia', contactName: 'Kevin Tan', contactEmail: 'kevin.tan@qucoon.com', budget: 70000, efficiencyScore: 90, status: 'active' },
  ],
  recommendationTypes: [
    { type: 'rightsizing', label: 'Rightsizing' },
    { type: 'idle_resource', label: 'Idle Resources' },
...
const gcpConfig: ProviderConfig = {
  ...
  colors: {
    ...
    chartPrimary: '#4285F4',
    chartPalette: ['#4285F4', '#EA4335', '#FBBC05', '#34A853', '#669DF6', '#F4B400', '#0F9D58', '#AB47BC', '#E67C73', '#57BB8A', '#7986CB', '#A1887F', '#4DB6AC', '#FF8A65', '#9575CD', '#4FC3F7', '#81C784', '#FFB74D'],
  },
  ...
  orgUnits: [
    { id: 'proj-001', name: 'production-web-app', description: 'Production web application', environment: 'Prod Web', primaryRegion: 'us-central1', contactName: 'Alex Rivera', contactEmail: 'alex.rivera@qucoon.com', budget: 280000, efficiencyScore: 85, status: 'active' },
    { id: 'proj-002', name: 'production-api', description: 'Production API services', environment: 'Prod API', primaryRegion: 'us-east1', contactName: 'Nina Sharma', contactEmail: 'nina.sharma@qucoon.com', budget: 220000, efficiencyScore: 81, status: 'active' },
    { id: 'proj-003', name: 'data-analytics-prod', description: 'Analytics and BigQuery', environment: 'Analytics', primaryRegion: 'us-central1', contactName: 'Marcus Chen', contactEmail: 'marcus.chen@qucoon.com', budget: 350000, efficiencyScore: 89, status: 'active' },
    { id: 'proj-004', name: 'ml-training-platform', description: 'ML training pipelines', environment: 'ML/AI', primaryRegion: 'us-west1', contactName: 'Yuki Tanaka', contactEmail: 'yuki.tanaka@qucoon.com', budget: 420000, efficiencyScore: 73, status: 'active' },
    { id: 'proj-005', name: 'dev-environment', description: 'Development workspace', environment: 'Dev', primaryRegion: 'europe-west1', contactName: 'Luca Bianchi', contactEmail: 'luca.bianchi@qucoon.com', budget: 90000, efficiencyScore: 68, status: 'active' },
    { id: 'proj-006', name: 'staging-environment', description: 'Staging and pre-prod', environment: 'Staging', primaryRegion: 'europe-west2', contactName: 'Fatima Al-Hassan', contactEmail: 'fatima.alhassan@qucoon.com', budget: 75000, efficiencyScore: 72, status: 'active' },
    { id: 'proj-007', name: 'shared-infrastructure', description: 'Shared platform services', environment: 'Platform', primaryRegion: 'us-central1', contactName: 'Ryan Murphy', contactEmail: 'ryan.murphy@qucoon.com', budget: 160000, efficiencyScore: 86, status: 'active' },
    { id: 'proj-008', name: 'mobile-backend', description: 'Mobile app backend', environment: 'Mobile', primaryRegion: 'asia-southeast1', contactName: 'Wei Zhang', contactEmail: 'wei.zhang@qucoon.com', budget: 130000, efficiencyScore: 78, status: 'active' },
  ],
  recommendationTypes: [
    { type: 'rightsizing', label: 'Rightsizing' },
    { type: 'idle_resource', label: 'Idle Resources' },
...
const huaweiConfig: ProviderConfig = {
  ...
  colors: {
    ...
    chartPrimary: '#C8102E',
    chartPalette: ['#E53935', '#1E88E5', '#43A047', '#FB8C00', '#8E24AA', '#00ACC1', '#D81B60', '#5E35B1', '#00897B', '#7CB342', '#F4511E', '#3949AB', '#C0CA33', '#6D4C41', '#039BE5', '#E91E63', '#1565C0', '#558B2F', '#FF6F00', '#4527A0', '#00695C', '#BF360C', '#283593'],
  },
...
export function getServiceInfo(provider: CloudProvider): Record<string, { name: string; category: string; color: string }> {
  ...
  if (provider === 'aws') {
    ...
    Object.assign(categories, {
      'ECS': 'Compute', 'FunctionGraph': 'Compute', 'CCE': 'Compute', 'SWR': 'Compute',
      'OBS': 'Storage', 'EVS': 'Storage',
      'RDS': 'Database', 'DCS': 'Database', 'DDS': 'Database', 'GaussDB': 'Database', 'DWS': 'Database',
      'ELB': 'Network', 'VPC': 'Network', 'CDN': 'Network', 'NAT': 'Network',
      'WAF': 'Security',
      'APIG': 'Application', 'SMN': 'Application', 'CTS': 'Application',
      'ModelArts': 'AI',
      'CSS': 'Analytics', 'MRS': 'Analytics', 'DLI': 'Analytics',
    });
  }
