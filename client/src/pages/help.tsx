...
function useFaqs() {
  ...
  return [
    {
      question: `How do I connect my ${config.shortName} account?`,
      answer: `Navigate to Settings > API Keys and enter your ${config.name} credentials (${creds.key1}, ${creds.key2}, and ${creds.key3}). These can be found in your ${config.terminology.ssoName} console.`,
    },
    {
      question: 'Which cloud providers are supported?',
      answer: 'The platform supports AWS, Microsoft Azure, Google Cloud Platform (GCP), and Huawei Cloud. Select your provider on the landing screen to get started.',
    },
    {
      question: 'How often is cost data updated?',
      answer: `Cost data is synchronized daily from ${config.name} billing APIs. Resource utilization metrics are updated hourly via ${config.terminology.monitoring}.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Recommendations are generated by analyzing resource utilization patterns, billing data, and usage trends via ${config.terminology.recommendationSource} to identify ${config.terminology.savingsMechanism}, rightsizing opportunities, and idle resources.`,
    },
  ];
}
